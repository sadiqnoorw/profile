<template>
    <div>
        ...
        <!-- ============================================================== -->
        <header v-if="!user" class="topbar" data-navbarbg="skin5">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                ...
                                <router-link to="/" class="dropdown-item">
                                    <i class="fa fa-power-off me-1 ms-1"></i> Login
                                </router-link>
                            </ul>
                        </li>
                        <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
        <aside v-if="user"  class="left-sidebar" data-sidebarbg="skin5">
            <!-- Sidebar scroll-->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        <li class="sidebar-item"> 
                            <router-link to="/dashboard" class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false">
